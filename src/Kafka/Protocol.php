...
use Kafka\Protocol\Protocol as NewProtocol;
...
class Protocol {
    ...
    {
        $class = array(
            NewProtocol::PRODUCE_REQUEST => 'Produce',
            NewProtocol::FETCH_REQUEST => 'Fetch',
            NewProtocol::OFFSET_REQUEST => 'Offset',
            NewProtocol::METADATA_REQUEST => 'Metadata',
            NewProtocol::OFFSET_COMMIT_REQUEST => 'CommitOffset',
            NewProtocol::OFFSET_FETCH_REQUEST => 'FetchOffset',
            NewProtocol::GROUP_COORDINATOR_REQUEST => 'GroupCoordinator',
            NewProtocol::JOIN_GROUP_REQUEST => 'JoinGroup',
            NewProtocol::HEART_BEAT_REQUEST => 'Heartbeat',
            NewProtocol::LEAVE_GROUP_REQUEST => 'LeaveGroup',
            NewProtocol::SYNC_GROUP_REQUEST => 'SyncGroup',
            NewProtocol::DESCRIBE_GROUPS_REQUEST => 'DescribeGroups',
            NewProtocol::LIST_GROUPS_REQUEST => 'ListGroup',
        );
